...
SoundFile  sA, sB, sC, sD, sE, sF, sG;
...
void setup() {
  ...
  sA = new SoundFile(this, "scA.wav");
  sB = new SoundFile(this, "scB.wav");
  sC = new SoundFile(this, "scC.wav");
  sD = new SoundFile(this, "scD.wav");
  sE = new SoundFile(this, "scE.wav");
  sF = new SoundFile(this, "scF.wav");
  sG = new SoundFile(this, "scG.wav");
}
...
void draw() {
  ...
  if(counter == 11) {
    ...
    System.out.println("Frame 9 is " + c8);
    counter = -1;;
  }
